...
n1.printNumbers(); // Prints the numbers along with their indexes
console.log(n1.odds()); // Returns odd numbers
console.log(n1.evens()); // Returns even numbers
console.log(n1.sum()); // Returns the sum of numbers
console.log(n1.product()); // Returns the product of numbers
